...
export const COOLIFY_UPSTREAM = {
  ...
  verifiedAt: '2026-09-20T08:54:24.312Z',
} as const
...
export const SERVICE_TEMPLATES: ServiceTemplate[] = [
  ...
  },
  {
    ...
    verification: 'failed',
    warnings: [
      'Verification gate failed: service "esphome" uses unsupported Compose key "privileged"',
    ],
  ...
  },
  {
    ...
    verification: 'failed',
    warnings: [
      "Verification gate failed: (HTTP code 500) server error - invalid volume specification: 'gs-test-sbx-0b8a26ea51d1-garage-anon-2:[object Object]': invalid mount config for type \"volume\": invalid mount path: '[object Object]' mount path must be absolute ",
    ],
  ...
  },
  {
    ...
    verification: 'failed',
    warnings: [
      'Verification gate failed: service "labelstudio" reported unhealthy: % Total    % Received % Xferd  Average Speed   Time    Time     Time  Current\n                                 Dload  Upload   Total   Spent    Left  Speed\n\r  0     0   0     0   0     0     0     0  ',
    ],
  ...
  },
  {
    ...
    publishable: false,
    verification: 'failed',
    warnings: ['Verification gate failed: service "openclaw" exited with code 1'],
  ...
  },
  {
    ...
    verification: 'failed',
    warnings: [
      'Verification gate failed: (HTTP code 500) server error - Head "https://registry-1.docker.io/v2/library/postgres/manifests/17": Get "https://auth.docker.io/token?scope=repository%3Alibrary%2Fpostgres%3Apull&service=registry.docker.io": read tcp 10.1.0.251:49436->172.64.144.78:443: read: connection reset by peer ',
    ],
  ...
  },
  {
    ...
    verification: 'failed',
    warnings: [
      'Verification gate failed: service "vuetorrent-backend" reported unhealthy: wget: server returned error: HTTP/1.1 404 Not Found',
    ],
  ...
  },
  {
    ...
    verification: 'failed',
    warnings: [
      'Verification gate failed: (HTTP code 500) server error - Head "https://registry-1.docker.io/v2/wolveix/satisfactory-server/manifests/v1.9.10": Get "https://auth.docker.io/token?scope=repository%3Awolveix%2Fsatisfactory-server%3Apull&service=registry.docker.io": read tcp 10.1.0.251:49450->172.64.144.78:443: read: connection reset by peer ',
    ],
