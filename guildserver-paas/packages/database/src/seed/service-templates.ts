...
export const SERVICE_TEMPLATES: ServiceTemplate[] = [
  ...
  },
  {
    ...
    publishable: false,
    verification: 'failed',
    warnings: ['Verification gate failed: timed out after 300s waiting for health'],
  ...
  },
  {
    ...
    publishable: false,
    verification: 'failed',
    warnings: ['Verification gate failed: service "flowise" exited with code 1'],
  ...
  },
  {
    ...
    services: [
      {
        name: 'hermes-agent',
        image:
          'nousresearch/hermes-agent@sha256:2f1f2f1725e5dc9a61cf6a2dea5aca52a776ec4d022cb29679e6aa3ff303e77a',
        hasHealthcheck: true,
        ports: [],
        oneShot: false,
      },
    ...
    publishable: false,
    verification: 'failed',
    warnings: ['Verification gate failed: service "hermes-agent" exited with code 127'],
  ...
  },
  {
    ...
    verification: 'failed',
    warnings: [
      "Verification gate failed: (HTTP code 500) server error - invalid volume specification: 'gs-test-sbx-fdf82b7406b9-librechat-anon-3:[object Object]': invalid mount config for type \"volume\": invalid mount path: '[object Object]' mount path must be absolute ",
    ],
  ...
  },
  {
    ...
    verification: 'failed',
    warnings: [
      "Verification gate failed: (HTTP code 500) server error - invalid volume specification: 'gs-test-sbx-b56295fb5832-litellm-anon-0:[object Object]': invalid mount config for type \"volume\": invalid mount path: '[object Object]' mount path must be absolute ",
    ],
  ...
  },
  {
    ...
    publishable: false,
    verification: 'failed',
    warnings: ['Verification gate failed: service "openclaw" exited shortly after start (code 1)'],
