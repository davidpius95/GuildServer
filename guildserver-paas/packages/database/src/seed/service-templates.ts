...
export const COOLIFY_UPSTREAM = {
  ...
  verifiedAt: '2026-09-13T08:37:58.231Z',
} as const
...
export const SERVICE_TEMPLATES: ServiceTemplate[] = [
  ...
  },
  {
    ...
    verification: 'failed',
    warnings: [
      "Verification gate failed: (HTTP code 500) server error - invalid volume specification: 'gs-test-sbx-eebf6056d41e-garage-anon-2:[object Object]': invalid mount config for type \"volume\": invalid mount path: '[object Object]' mount path must be absolute ",
    ],
  ...
  },
  {
    ...
    verification: 'failed',
    warnings: [
      'Verification gate failed: (HTTP code 500) server error - received unexpected HTTP status: 500 Internal Server Error ',
    ],
